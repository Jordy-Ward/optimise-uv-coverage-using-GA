...
\While{the termination criterin is not met}
...
\begin{enumerate}
    \item \textbf{Standard Baseline:} The baseline configuration utilised a tpurnament size of five and a mutation rate 0.15.
