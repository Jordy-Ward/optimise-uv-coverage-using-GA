...
if __name__ == "__main__":
    ...
    for run in range(NUM_RUNS):
        ...
        ga = GeneticAlgorithm(num_antennas=64, k=16, pop_size=POP_SIZE, 
                      generations=GENERATIONS, mutation_rate=0.15, 
                      niche_radius=12) # Increased from 4
    ...
    np.save("../out/ga_v2_all_histories.npy", np.array(all_histories))
    np.save("../out/ga_v2_absolute_best_layout.npy", best_overall_layout)
    print("Data saved to out/ga_v2_all_histories.npy and out/ga_v2_absolute_best_layout.npy")