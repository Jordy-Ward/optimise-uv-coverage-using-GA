...
if __name__ == "__main__":
    ...
    for run in range(NUM_RUNS):
        ...
        ga = GeneticAlgorithm(num_antennas=64, k=16, pop_size=POP_SIZE, 
                      ...
                      tournament_size=2) # Reduced from 5
    ...
    np.save("../out/ga_v1_all_histories.npy", np.array(all_histories))
    np.save("../out/ga_v1_absolute_best_layout.npy", best_overall_layout)
    print("Data saved to out/ga_v1_all_histories.npy and out/ga_v1_absolute_best_layout.npy")