...
if __name__ == "__main__":
    ...
    for run in range(NUM_RUNS):
        ...
        ga = GeneticAlgorithm(num_antennas=64, k=16, pop_size=POP_SIZE, 
                      generations=GENERATIONS, mutation_rate=0.25, # Increased from 0.15
                      tournament_size=3) # Moderate pressure
    ...
    np.save("../out/ga_v3_all_histories.npy", np.array(all_histories))
    np.save("../out/ga_v3_absolute_best_layout.npy", best_overall_layout)
    print("Data saved to out/ga_v3_all_histories.npy and out/ga_v3_absolute_best_layout.npy")